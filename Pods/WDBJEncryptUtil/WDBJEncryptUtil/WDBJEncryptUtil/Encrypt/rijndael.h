...
int rijndaelSetupEncryptInOPS(unsigned long *rk, const unsigned char *key,
  int keybits);
int rijndaelSetupDecryptInOPS(unsigned long *rk, const unsigned char *key,
  int keybits);
void rijndaelEncryptInOPS(const unsigned long *rk, int nrounds,
  const unsigned char plaintext[16], unsigned char ciphertext[16]);
void rijndaelDecryptInOPS(const unsigned long *rk, int nrounds,
