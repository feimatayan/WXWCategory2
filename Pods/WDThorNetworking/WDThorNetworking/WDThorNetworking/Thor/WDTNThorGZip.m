...
+ (NSData *)gzipCompress:(NSData *)inputData {
    ...
    zlibStreamStruct.next_in = (Bytef *)[inputData bytes];
    zlibStreamStruct.avail_in = (uInt)[inputData length];
    ...
    NSMutableData *compressedData = [NSMutableData dataWithLength:([inputData length] + 12) * 2];
    int deflateStatus;
    do {
